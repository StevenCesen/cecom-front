import useLabelPayWay from "../../hooks/useLabelPayWay.js";

export default async function CardNewTicket(){
    const template=`
        <div class="CardNewTicket">
            <h3 class="CardNewTicket__title">Información del ticket</h3>

            <div class="CardNewTicket__principal">
                <label>
                    Motivo
                ...
                <label>
                    Fecha de entrega
                    <input type="date" id="date-ticket">
                </label>

                <label>
                    Descripción de inicio
                    <textarea id="description-ticket" placeholder="Añade una descripción para inicio del ticket"></textarea>
                </label>

                <label>
                    C.I./R.U.C:
                    <input type="text" placeholder="Escribe aquí..." id="client-ci">
                </label>
            </div>

            <h4>¿El equipo lo entregan con?</h4>

            <div class="CardNewTicket__addcomplement">
                <label>
                    <input type="text" placeholder="Escribe aqui..." id="text-complement">
                    <input type="number" value="0" id="quantity-complement" required>
                </label>

                <label class="CardNewTicket__addfile" for="file-ticket">
                    ...
                    <input type="file" id="file-ticket">
                </label>

                <button id="add-complement">
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="CardNewTicket__complements" id="content-complements">
            </div>

            <h4>¿Qué se va a cobrar?</h4>

            <label class="CardNewTicket__search">
            ...
            <div class="CardNewTicket__products" id="content-products">
                
            </div>

            <label class="CardNewTicket__values">
                <h4>Subtotal: </h4>
                <h4 id="subtotal"></h4>
            </label>
            ...
            <div class="CardNewTicket__footer">
